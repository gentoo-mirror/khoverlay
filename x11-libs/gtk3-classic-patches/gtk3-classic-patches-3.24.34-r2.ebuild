...
# Releases of gtk3-classic prior to 3.24.34.2 are incompatible with >=glib-2.74.0:
# https://github.com/lah7/gtk3-classic/issues/79
RDEPEND="!<x11-libs/gtk3-classic-patches-3.24.34-r1
