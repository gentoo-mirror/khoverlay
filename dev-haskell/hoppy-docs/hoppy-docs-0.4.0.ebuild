...
RDEPEND=">=dev-haskell/haskell-src-1.0:=[profile?] <dev-haskell/haskell-src-1.1:=[profile?]
	>=dev-haskell/hoppy-generator-0.4:=[profile?] <dev-haskell/hoppy-generator-0.5:=[profile?]
	>=dev-haskell/hoppy-runtime-0.4:=[profile?] <dev-haskell/hoppy-runtime-0.5:=[profile?]
	>=dev-lang/ghc-7.8.2:=
"
DEPEND="${RDEPEND}
