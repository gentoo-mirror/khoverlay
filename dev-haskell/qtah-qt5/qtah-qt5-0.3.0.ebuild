...
RDEPEND=">=dev-haskell/hoppy-runtime-0.3:=[profile?] <dev-haskell/hoppy-runtime-0.4:=[profile?]
	>=dev-haskell/qtah-cpp-qt5-0.3:=[profile?] <dev-haskell/qtah-cpp-qt5-0.4:=[profile?]
	>=dev-haskell/qtah-generator-0.3:=[profile?] <dev-haskell/qtah-generator-0.4:=[profile?]
	>=dev-lang/ghc-7.8.2:=
"
DEPEND="${RDEPEND}
